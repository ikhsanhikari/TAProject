<%-- 
    Document   : form_tambah_dosen
    Created on : Sep 12, 2018, 10:32:07 PM
    Author     : hikari
--%>
    ...
    <!--        <p>User Sekarang adalah ${username} dengan password ${password} / silahkan log out untuk menghapus session ini</p>-->
            <div class="account-container register">
                <div class="content clearfix">
                    <form action="saveDosen.htm" method="post">
                        ...
                        <div class="login-fields">
                            ...
                            <form:hidden path="id_role" value="2"/>
                            <form:hidden path="dosen" value="0"/>
