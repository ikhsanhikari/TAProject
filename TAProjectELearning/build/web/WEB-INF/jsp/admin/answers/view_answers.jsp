...
<html>
    ...
    <body>
            ...
            <div class="subnavbar-inner">
                <div class="container">
                    <ul class="mainnav">
                        ...
                        <li class="active"><a href="view_answers.htm"><i class="icon-star"></i><span>Answers</span> </a> </li>
        ...
        <p><a href="form_tambah_answers.htm">Tambah Answers</a></p>
        <!-- /widget -->
        <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-th-list"></i>
                <h3>Daftar Answers</h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th width="100px"> Id Answers </th>
                            <th width="100px"> Answers </th>
                            <th class="td-actions"> Action </th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="data" items="${listAnswers}">
                            <c:url var="delete" value="delete_answers.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <c:url var="update" value="form_ubah_answers.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <tr>
                                <td>${data.id}</td>
