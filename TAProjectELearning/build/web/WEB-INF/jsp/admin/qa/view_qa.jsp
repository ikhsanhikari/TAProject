...
<html>
    ...
    <body>
            ...
            <div class="subnavbar-inner">
                <div class="container">
                    <ul class="mainnav">
                        ...
                        <li class="active"><a href="view_qa.htm"><i class="icon-tasks"></i><span>Question Answers</span> </a> </li>
        ...
        <p><a href="form_tambah_qa.htm">Tambah Question</a></p>
        <!-- /widget -->
        <div class="widget widget-table action-table">
            ...
            <div class="widget-content">
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th width="100px"> Id QA </th>
                            <th width="100px"> Question </th>
                            <th width="100px"> Answers </th>
                            <th width="100px"> Level </th>
                            <th width="100px"> Jenis Soal </th>
                            <th class="td-actions"> Action </th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="data" items="${listQa}">
                            <c:url var="delete" value="delete_qa.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <c:url var="update" value="form_ubah_qa.htm">
                                <c:param name="id" value="${data.id}"/>
                            </c:url>
                            <tr>
                                <td>${data.id}</td>
