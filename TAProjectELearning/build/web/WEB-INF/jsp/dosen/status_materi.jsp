<%-- 
    Document   : status_materi
    Created on : Jun 30, 2018, 9:32:40 AM
    Author     : hikari
--%>
...
<html>
    ...
    <body>
        ...
        <div class="widget-content span12">
            <div class="shortcuts"> 
                <a href="ubahStatus.htm?status=1" class="shortcut"><i class="shortcut-icon icon-bar-chart"></i>
                    <span class="shortcut-label">Sekuensial</span> 
                </a>
                <a href="ubahStatus.htm?status=2" class="shortcut"><i class="shortcut-icon icon-question"></i>
                    <span class="shortcut-label">Kondisional</span> 
                </a>
                <a href="ubahStatus.htm?status=3" class="shortcut"><i class="shortcut-icon icon-sort"></i>
