 ...
 */
@Repository
public class Tb_resultquizDaoImpl extends HibernateUtil implements Tb_resultquizDao{

    @Override
    public List<Tb_resultquizModel> getData() {
        List<Tb_resultquizModel> listData = new ArrayList<>();
        String sql = "select model from Tb_resultquizModel model";
    ...
    public List<Tb_resultquizModel> getDataById(Integer id) {
        List<Tb_resultquizModel> listData = new ArrayList<>();
        try {
            String sql = "select model from Tb_resultquizModel model where id = :id";
